        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              The AI-powered freelancing platform connecting talented professionals with clients worldwide.
              Find work, hire talent, and grow your career.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/find-work" className="hover:text-white transition-colors">
                  Find Work
                </Link>
              </li>
              <li>
                <Link href="/how-to-start" className="hover:text-white transition-colors">
                  How to Start
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/hire-talent" className="hover:text-white transition-colors">
                  Hire Talent
                </Link>
              </li>
              <li>
